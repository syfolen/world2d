...
var Stat=(function(){
	...
	*/
	...
	Stat.show=function(x,y){
		...
		if (!Render.isConchWebGL && !Browser.onMiniGame &&! Browser.onLimixiu && !Browser.onKGMiniGame && !Browser.onBDMiniGame&& !Browser.onTTMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onBLMiniGame)Stat._useCanvas=true;
		Stat._show=true;
...
var Input=(function(_super){
	...
	*/
	...
	__proto._focusIn=function(){
		...
		if(!Browser.onMiniGame && !Browser.onBDMiniGame && !Browser.onTTMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onBLMiniGame){
			var temp=this._text;
			this._text=null;
		}
		this.typeset();
	...
	*/
	...
	Input.__init__=function(){
		...
		if (Browser.onMobile){
			var isTrue=false;
			if(Browser.onMiniGame || Browser.onBDMiniGame || Browser.onKGMiniGame || Browser.onTTMiniGame || Browser.onQGMiniGame || Browser.onVVMiniGame ||Browser.onBLMiniGame){
				isTrue=true;
			}
